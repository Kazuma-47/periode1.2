...
vloer2.setPosition(14, 0 , 0);

const vloer3 = new Model('webxr/kamer/vloer/scene.gltf');
vloer3.setScale(7, 7, 7);
vloer3.setRotation(0, 0, 0);
vloer3.setPosition(28, 0 , 0);

const vloer4 = new Model('webxr/kamer/vloer/scene.gltf');
vloer4.setScale(7, 7, 7);
vloer4.setRotation(0, 0, 0);
vloer4.setPosition(28, 0 , -14);

const vloer5 = new Model('webxr/kamer/vloer/scene.gltf');
vloer5.setScale(7, 7, 7);
vloer5.setRotation(0, 0, 0);
vloer5.setPosition(28, 0 , -28);

const vloer6 = new Model('webxr/kamer/vloer/scene.gltf');
vloer6.setScale(7, 7, 7);
vloer6.setRotation(0, 0, 0);
vloer6.setPosition(14, 0 , -28);

const vloer7 = new Model('webxr/kamer/vloer/scene.gltf');
vloer7.setScale(7, 7, 7);
vloer7.setRotation(0, 0, 0);
vloer7.setPosition(14, 0 , -14);

const vloer8 = new Model('webxr/kamer/vloer/scene.gltf');
vloer8.setScale(7, 7, 7);
vloer8.setRotation(0, 0, 0);
vloer8.setPosition(0, 0 , -14);

const vloer9 = new Model('webxr/kamer/vloer/scene.gltf');
vloer9.setScale(7, 7, 7);
vloer9.setRotation(0, 0, 0);
vloer9.setPosition(0, 0 , -28);
...
vloerL1.setPosition(-14, 0 , -28);

const vloerL2 = new Model('webxr/kamer/vloer/scene.gltf');
vloerL2.setScale(7, 7, 7);
vloerL2.setRotation(0, 0, 0);
vloerL2.setPosition(-14, 0 , -14);

const vloerL3 = new Model('webxr/kamer/vloer/scene.gltf');
vloerL3.setScale(7, 7, 7);
vloerL3.setRotation(0, 0, 0);
vloerL3.setPosition(-14, 0 , -14);
...
const vloerL5 = new Model('webxr/kamer/vloer/scene.gltf');
vloerL5.setScale(7, 7, 7);
vloerL5.setRotation(0, 0, 0);
vloerL5.setPosition(-14, 0 , 0);
...
image5.setScale(0.6, 0.6, 0.6);
image5.setRotation(0, -36.95, 0);
image5.setPosition(0.4436, -3 , -3.00392);
